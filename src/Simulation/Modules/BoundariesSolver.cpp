...
//
#include "Simulation/Modules/BoundariesSolver.h"
...
void BoundariesSolver::bordersAvoid(Boid &obj) {
    ...
    if (obj.m_position.x > (float) Settings::General::WindowWidth - Settings::Model::WindowMargin)
        obj.m_acceleration.x +=
                ((float) Settings::General::WindowWidth - Settings::Model::WindowMargin - obj.m_position.x) *
                Settings::Model::TurnFactor;

    // Bottom
    if (obj.m_position.y > (float) Settings::General::WindowHeight - Settings::Model::WindowMargin)
        obj.m_acceleration.y +=
                ((float) Settings::General::WindowHeight - Settings::Model::WindowMargin - obj.m_position.y) *
                Settings::Model::TurnFactor;
}
