...
//
# include "Simulation/ModelSolver.h"

ModelSolver::ModelSolver(LinearContainer<Boid> &targets) :
        m_targets(targets) {}
...
void ModelSolver::wonder(Boid &obj) {
    ...
    obj.m_acceleration += norm(obj.m_desiredDirection * obj.m_maxSpeed - obj.m_velocity) *
                          Settings::Boid::SteerStrength;
}
